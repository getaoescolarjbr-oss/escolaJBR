...
// Lote 9 de professores extraídos
const horariosExtraidos = {
  "Andrey Monteiro Borges": [
    { dia: 5, tempo: 6, disciplina: "Unidade Curricular III", turma: "1º Ano C" },
    { dia: 5, tempo: 8, disciplina: "Unidade Curricular III", turma: "2º Ano C" }
  ]
};
