        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                { id: 'gradual', label: 'Gradual (0 / 0,5 / 1,0)', desc: '0 = viu, não fez · 0,5 = 50% · 1,0 = 100% · vazio = não viu' },
                { id: 'simbolico', label: 'Simbólico (+ / -)', desc: '+ feito 100%, − feito 50%' },
                { id: 'aberto', label: 'Campo Aberto (0-10)', desc: 'Notas numéricas diretas' },
                { id: 'ponto', label: 'Ponto (·)', desc: 'Azul 100% · laranja 50% · vermelho viu sem nota · de novo desmarca' },
              ].map((metodo) => (
                <button
                  key={metodo.id}
