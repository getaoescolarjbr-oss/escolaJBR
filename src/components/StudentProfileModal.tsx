          ...
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            <div className="relative flex-shrink-0">
              {fotoUrl ? (
                <img
                  src={fotoUrl}
                  alt={studentName}
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover border-2 border-ms-blueText/40 shadow-lg shadow-ms-blue/20"
                />
              ) : (
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-ms-blue/20 flex items-center justify-center text-2xl sm:text-3xl font-black text-ms-blueText border-2 border-ms-blueText/30 shadow-inner flex-shrink-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-[#004b93] dark:text-blue-400 font-extrabold uppercase tracking-widest flex items-center gap-1">
                <FileText className="w-3 h-3 text-ms-blueText" /> Ficha do Estudante
              </p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 bg-ms-dark/20 border-2 border-ms-blueText/40 rounded-[2rem] p-6 shadow-lg shadow-ms-blue/5">
                  <div className="flex items-center gap-3 mb-6">
                    <Activity className="w-5 h-5 text-ms-blueText" />
                    <h3 className="text-sm font-black text-white uppercase tracking-wider">
                  ...
                  {todasDisciplinas.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[220px] overflow-y-auto pr-2 custom-scrollbar">
                      {todasDisciplinas.map(disc => {
                        ...
                        return (
                          <div key={disc} className="bg-black/25 rounded-xl p-3 border border-ms-blueText/30 flex flex-col justify-between hover:border-ms-blueText/60 transition-all">
                            <div className="flex justify-between items-center mb-2">
                              ...
                              <span className="text-[11px] font-black text-ms-blueText">{percentual}%</span>
                            </div>
                ...
                <div className="flex items-center justify-between gap-3 mb-6">
                  ...
                  {isCoordinator && filterOcorrencias.length > 0 && (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-ms-blue/10 hover:bg-ms-blue/20 border border-ms-blueText/30 text-ms-blueText font-bold rounded-xl text-xs transition-colors"
                    >
