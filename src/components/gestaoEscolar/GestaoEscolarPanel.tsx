...
function IndicadorTile({ label, valor, tom }: IndicadorTileProps) {
  if (!temDados(valor)) {
    return (
      <div className="bg-ms-dark border border-dashed border-gray-700 rounded-2xl p-5 flex flex-col gap-2">
  ...
  return (
    <div className="bg-ms-card border border-gray-800 rounded-2xl p-5 flex flex-col gap-1">
      <p className="text-[11px] uppercase tracking-wider text-gray-500 font-bold">{label}</p>
...
function BreakdownTile({ label, contagens }: { label: string; contagens: Record<string, number> }) {
  ...
  return (
    <div className="bg-ms-card border border-gray-800 rounded-2xl p-5 flex flex-col gap-2">
      <p className="text-[11px] uppercase tracking-wider text-gray-500 font-bold">{label}</p>
      {entradas.length === 0 ? (
